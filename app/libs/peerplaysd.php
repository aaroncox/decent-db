...
class steemd
{
  ...
  {
    try {
      $return = $this->client->call(0, 'get_full_accounts', [[$account], false]);
      try {
        return $return[0][1];
      } catch (Exception $e) {
        var_dump($e); exit;
  ...
  {
    // try {
      var_dump("history", $this->client->call(0, 'get_account_history', [$username, $limit])); exit;
      return $this->client->call(0, 'get_account_history', [$username, $limit]);
    // } catch (Exception $e) {
    //   return array();
    // }
  }
